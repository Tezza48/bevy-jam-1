...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('bevy-unfair-advantage_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
